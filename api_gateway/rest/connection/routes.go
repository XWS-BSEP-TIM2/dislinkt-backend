...
func RegisterRoutes(r *gin.Engine) {
	...
	authorizedRoutes.GET("/friends/:id", a.Authorize("getFriends", "read"), connectionHandler.GetFriends)
	authorizedRoutes.GET("/blocks", a.Authorize("getBlockedUsers", "read"), connectionHandler.GetBlocks)
	authorizedRoutes.GET("/friends-requests", a.Authorize("getFriendRequests", "read"), connectionHandler.GetFriendRequests)
