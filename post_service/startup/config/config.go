...
type Config struct {
	...
	LoggingServiceHost      string
	LoggingServicePort      string
}
...
func NewConfig() *Config {
	return &Config{
		...
		LoggingServiceHost: goDotEnvVariable("LOGGING_SERVICE_HOST"),
		LoggingServicePort: goDotEnvVariable("LOGGING_SERVICE_PORT"),
	}
}
