...
func initGraphDB(transaction neo4j.Transaction) error {
	_, err := transaction.Run(
		"CREATE (rasti:USER{userID: \"62752bf27407f54ce1839cb9\", username: \"rasti\", isPrivate : false}), (zarko:USER{userID: \"62752bf27407f54ce1839cb6\", username: \"zarkoo\", isPrivate : false}), (tara:USER{userID: \"62752bf27407f54ce1839cb7\", username: \"Jelovceva\", isPrivate : false}), (djordje:USER{userID: \"62752bf27407f54ce1839cb8\", username: \"djole\", isPrivate : false}),   (srdjan:USER{userID: \"62752bf27407f54ce1839cb3\", username: \"srdjan\", isPrivate : false}), (marko:USER{userID: \"62752bf27407f54ce1839cb2\", username: \"marko99\", isPrivate : false}), (nikola:USER{userID: \"62752bf27407f54ce1839cb4\", username: \"nikola93\", isPrivate : false}),  (svetozar:USER{userID: \"62752bf27407f54ce1839cb5\", username: \"svetozar\", isPrivate : false}),   (rasti) -[:FRIEND{msgID:\"aaa111\"}]-> (zarko), (rasti) <-[:FRIEND{msgID:\"aaa111\"}]- (zarko), (rasti) -[:FRIEND{msgID:\"aaa112\"}]-> (tara), (rasti) <-[:FRIEND{msgID:\"aaa112\"}]- (tara), (rasti) -[:FRIEND{msgID:\"aaa113\"}]-> (djordje), (rasti) <-[:FRIEND{msgID:\"aaa113\"}]- (djordje), (rasti) -[:FRIEND{msgID:\"aaa114\"}]-> (srdjan), (rasti) <-[:FRIEND{msgID:\"aaa114\"}]- (srdjan), (rasti) -[:FRIEND{msgID:\"aaa115\"}]-> (marko), (rasti) <-[:FRIEND{msgID:\"aaa115\"}]- (marko), (rasti) -[:FRIEND{msgID:\"aaa116\"}]-> (nikola), (rasti) <-[:FRIEND{msgID:\"aaa116\"}]- (nikola), (rasti) -[:FRIEND{msgID:\"aaa117\"}]-> (svetozar), (rasti) <-[:FRIEND{msgID:\"aaa117\"}]- (svetozar),  (zarko) -[:FRIEND{msgID:\"aaa118\"}]-> (tara), (zarko) <-[:FRIEND{msgID:\"aaa118\"}]- (tara), (zarko) -[:FRIEND{msgID:\"aaa119\"}]-> (djordje), (zarko) <-[:FRIEND{msgID:\"aaa119\"}]- (djordje), (zarko) -[:FRIEND{msgID:\"aaa120\"}]-> (svetozar), (zarko) <-[:FRIEND{msgID:\"aaa120\"}]- (svetozar),  (tara) -[:FRIEND{msgID:\"aaa121\"}]-> (djordje), (tara) <-[:FRIEND{msgID:\"aaa121\"}]- (djordje), (tara) -[:FRIEND{msgID:\"aaa122\"}]-> (svetozar), (tara) <-[:FRIEND{msgID:\"aaa122\"}]- (svetozar),  (djordje) -[:FRIEND{msgID:\"aaa123\"}]-> (srdjan), (djordje) <-[:FRIEND{msgID:\"aaa123\"}]- (srdjan),  (marko) -[:BLOCK]-> (djordje), (tara) -[:BLOCK]-> (marko) ",
		map[string]interface{}{})
	return err
}
